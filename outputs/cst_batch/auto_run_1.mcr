...
Sub Main()
    ...
    Debug.Print "[1] Updating parameters..."
    StoreDoubleParameter "patch_length", 12.0
    StoreDoubleParameter "patch_width", 10.0

    Debug.Print "[1] Rebuilding..."
    proj.Rebuild

    Debug.Print "[1] Starting simulation..."
    ...
    If Not solver Is Nothing Then
        ...
        Do While solver.IsSimulating
            Sleep 1000
        Loop
        Debug.Print "[1] Simulation done"

        Debug.Print "[1] Exporting S11..."
        ...
        For i = 0 To results.Count - 1
            ...
            If Not item Is Nothing Then
                ...
                If InStr(itemName, "S1,1") > 0 Or InStr(itemName, "S11") > 0 Then
                    item.ExportCurve "default", "outputs\\cst_batch\\s11_iter_1.txt", True
                    exportSuccess = True
                    Exit For
                End If
            End If
    ...
    Set flagFile = fso.CreateTextFile("outputs\\cst_batch\\s11_iter_1.txt.done", True)
    flagFile.WriteLine "Iteration 1 completed"
    flagFile.Close

    If exportSuccess Then
        MsgBox "Iteration 1 completed!", vbInformation
    Else
        MsgBox "Iteration 1 done, export may have failed", vbExclamation
    End If
End Sub
