' CST FULLY AUTOMATIC EXECUTION - Iteration 5
...
Sub Main()
    ...
    Debug.Print "[AUTO] === Starting Automatic Execution 5 ==="
        ...
        If Not item Is Nothing Then
            ...
            If InStr(itemName, "S1,1") > 0 Or InStr(itemName, "S11") > 0 Or _
               InStr(itemName, "S-Parameter") > 0 Or InStr(itemName, "S Parameter") > 0 Then
                ...
                Err.Clear
                item.ExportCurve "default", "E:\\code\\cst_agent_demo\\outputs\\cst_fully_auto\\s11_iter_5.txt", True
    ...
    WriteStatus "SUCCESS", "Iteration 5 completed"
...
Sub WriteStatus(status As String, msg As String)
    ...
    Set ts = fso.CreateTextFile("E:\\code\\cst_agent_demo\\outputs\\cst_fully_auto\\s11_iter_5.txt.done", True)
